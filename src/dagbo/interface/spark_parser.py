...
def get_all_stages() -> None:
    ...
    resp = requests.get(f"http://localhost:18080/api/v1/applications/{APP_ID}/stages")
...
def get_a_stage() -> None:
    #resp = requests.get(f"http://localhost:18080/api/v1/applications/{APP_ID}/allexecutors")
    resp = requests.get(f"http://localhost:18080/api/v1/applications/{APP_ID}/stages/0/0")
...
def get_per_task() -> None:
    #resp = requests.get(f"http://localhost:18080/api/v1/applications/{APP_ID}/allexecutors")
    resp = requests.get(f"http://localhost:18080/api/v1/applications/{APP_ID}/stages/0/0/taskSummary")
...
def executors_metric() -> None:
    #resp = requests.get(f"http://localhost:18080/api/v1/applications/{APP_ID}/allexecutors")
    resp = requests.get(f"http://localhost:18080/api/v1/applications/{APP_ID}/executors")
