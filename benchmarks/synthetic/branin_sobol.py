...
from dagbo.interface.exec_branin import call_branin
...
FLAGS = flags.FLAGS
flags.DEFINE_string("metric_name", "branin", "metric name")
flags.DEFINE_string("exp_name", "branin", "Experiment name")
flags.DEFINE_integer("bootstrap", 5, "bootstrap", lower_bound=1)
flags.DEFINE_integer("n_dim", 2, "2-dim only")
...
class n_dim_Rosenbrock(Metric):
    def fetch_trial_data(self, trial, **kwargs):
        ...
        for arm_name, arm in trial.arms_by_name.items():
            ...
            # exec
            obj = call_branin(params, train_inputs_dict,
                                  train_targets_dict)
